...
#ifndef IXC_SCRIPT_SCRIPT_H
#define IXC_SCRIPT_SCRIPT_H
...
public:
    ...
    ixc::instruction_iterator begin_instructions() const;
    ixc::instruction_iterator end_instructions() const;
    ...
    /**
     * Pre-version-0.6, IXC always counted CHECKMULTISIGs as 20 sigops. With
...
bool IsP2SH(ixc::span<const uint8_t>);
bool IsDSNotification(ixc::span<const uint8_t>);
bool IsDustReturnScript (ixc::span<const uint8_t> script);


size_t CountOp(ixc::span<const uint8_t>, opcodetype);
