        ...
        while (pc < pend) {
            ...
            if (fExec && 0 <= opcode && opcode <= OP_PUSHDATA4) {
                ...
                switch (opcode) {
                    ...
                    case OP_DEPTH: {
                        // -- stacksize
                        const CScriptNum bn(ixc::bint{stack.size()});
                        stack.push_back(bn.getvch());
                    } break;
                    ...
                    case OP_SIZE: {
                        ...
                        CScriptNum bn(ixc::bint{stack.stacktop(-1).size()});
                        stack.push_back(bn.getvch());
                    } break;
