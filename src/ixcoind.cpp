 ...
 *
 * This is the developer documentation of IXCOIN
 * (https://www.ixcoin.com/). IXC is a client for the digital
 * currency called IXCOIN, which enables
 * instant payments to anyone, anywhere in the world. IXCOIN uses
...
bool AppInit(int argc, char *argv[]) {
    ...
    if (gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") ||
        ...
        if (gArgs.IsArgSet("-version")) {
            ...
            strUsage += "\n" + HelpMessage(HMM_IXCOIND, config);
        }
    ...
    try {
        ...
        try {
            gArgs.ReadConfigFile(gArgs.GetArg("-conf", IXC_CONF_FILENAME));
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) &&
                !boost::algorithm::istarts_with(argv[i], "ixc:"))
                fCommandLine = true;

        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in "
                            "ixcoind anymore. Use the ixcoin-cli utility "
                            "instead.\n");
            exit(EXIT_FAILURE);
        }
        // -server defaults to true for ixcoind
        ...
        if (gArgs.GetBoolArg("-daemon", false)) {
            ...
            fprintf(stdout, "\033[1;40;34m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒\033[0m\n"
                            "\033[1;40;34m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒\033[0m\033[1;40;32m╭━╮╭━╮╭╮  ╭╮╭━━━╮\033[0m\033[1;40;34m▒▒▒▒\033[0m\033[1;40;31mIXCOIN!\033[0m\033[1;40;34m▒▒▒▒\033[0m\n"
                            "\033[1;40;34m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒\033[0m\033[1;40;32m┃┃╰╯┃┃┃╰╮╭╯┃┃╭━╮┃\033[0m\033[1;40;34m▒▒▒▒  \033[0m\033[1;40;31mv0.2.1.0\033[0m\033[1;40;34m  ▒▒▒▒\033[0m\n"
