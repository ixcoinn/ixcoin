...
#ifndef IXC_VALIDATION_H
#define IXC_VALIDATION_H
...
static const uint64_t DEFAULT_FIRST_BLOCK_REWARD = 900000000000000;
extern uint64_t firstBlockReward;
static const uint64_t DEFAULT_INITIAL_REWARD = 2500000000;
extern uint64_t initialReward;
static const int DEFAULT_SUBSIDY_HALVING_INTERVAL = 60000;
...
static const uint64_t VESTING_TOTAL_AMOUNT = 500000000000000;
static const int VESTING_PERIOD_BLOCKS = 4380;
static const int VESTING_NUM_PERIODS = 12;
static const uint64_t VESTING_PER_PERIOD = VESTING_TOTAL_AMOUNT / VESTING_NUM_PERIODS;
