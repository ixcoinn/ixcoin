...
void CMVCSecret::SetKey(const CKey &vchSecret) {
...
bool CMVCSecret::SetString(const char *pszSecret) {
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CMVCSecret::SetString(const std::string &strSecret) {
