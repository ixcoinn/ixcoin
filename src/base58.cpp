...
void CIXCSecret::SetKey(const CKey &vchSecret) {
...
bool CIXCSecret::SetString(const char *pszSecret) {
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CIXCSecret::SetString(const std::string &strSecret) {
