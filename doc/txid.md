...
This document describes how to calculate the TXID for ixc.
...
To learn more about txid calculation, please read the code [here](https://github.com/ixc-labs/ixcoin/blob/master/src/hash.h#L239-L274).
