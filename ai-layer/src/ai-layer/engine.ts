// ============================================================
  ...
  function guardianDecision(ctx: DecisionContext): AiDecision {
    ...
    return { actionType, decision, rewardIssued: finalReward, energyCost: 8, expGained: 5 + ctx.ai.level * 2, outcome, metadata: { pressure, poolHealth, personalityMult, levelBonus } };
  }
  ...
  function optimizerDecision(ctx: DecisionContext): AiDecision {
    ...
    return { actionType, decision, rewardIssued: finalReward, energyCost: 10, expGained: 8 + ctx.ai.level * 3, outcome, metadata: { pressure, poolHealth, levelBonus, personalityMult } };
  }
  ...
  function balancerDecision(ctx: DecisionContext): AiDecision {
    ...
    return { actionType, decision, rewardIssued: finalReward, energyCost: 7, expGained: 6 + ctx.ai.level * 2, outcome, metadata: { pressure, poolHealth, imbalance, personalityMult } };
  }
